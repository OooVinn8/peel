...
@section('content')
    <div class="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-8">
        <div class="w-full max-w-6xl bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row min-h-[650px]">
            ...
            <div class="w-full md:w-[35%] flex flex-col justify-center px-6 sm:px-10 py-12">
                <div class="w-full max-w-sm mx-auto">
                    ...
                    <p class="mt-8 text-sm text-gray-600 text-center">
                        Belum punya akun?
                        <a href="{{ url('/register') }}" class="text-yellow-500 font-semibold hover:underline">Daftar di
                            sini</a>
                    </p>
                </div>
            </div>
            ...
            <div
                class="w-full md:w-[65%] hidden md:flex items-center justify-center bg-gradient-to-br from-red-50 to-yellow-50 px-6">
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <lottie-player src="{{ asset('images/LhuvVioiPQ.json') }}" background="transparent" speed="1"
                        style="width: 350px; height: 350px; max-width: 420px; max-height: 420px;" loop autoplay>
                    </lottie-player>
                </div>
            </div>
        </div>

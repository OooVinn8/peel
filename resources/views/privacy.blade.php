...
<section class="w-full bg-gray-50 text-gray-800">
  ...
  <div class="relative bg-blue-700">
    <div class="absolute inset-0 opacity-10">
      <img src="{{ asset('images/privacy-banner.jpg') }}" 
    ...
    <div class="bg-white rounded-2xl shadow-md p-8 md:p-12 border-t-8 border-yellow-400">
      ...
      <div class="space-y-10 leading-relaxed">
        ...
        <section>
          ...
          <p>
            Kami mengumpulkan data yang Anda berikan secara langsung, seperti nama, alamat email, nomor telepon, dan alamat pengiriman. 
            Selain itu, kami mencatat informasi pesanan Anda (menu, jumlah, catatan khusus). Data ini membantu kami memberikan layanan yang cepat dan tepat.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Kami tidak menjual data pribadi Anda. Data hanya dibagikan dengan pihak ketiga untuk keperluan pembayaran dan pengiriman. Semua pihak yang menerima data terikat pada perjanjian kerahasiaan yang ketat.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Kami melindungi data Anda dengan langkah teknis dan prosedural, termasuk enkripsi, kontrol akses, dan pembaruan sistem rutin. Meskipun demikian, tidak ada sistem yang 100% aman. Jika terjadi pelanggaran keamanan signifikan, kami akan memberi tahu Anda secepat mungkin.
          </p>
        </section>
        ...
        <section>
          ...
          <p class="relative">
            Layanan kami tidak ditujukan untuk anak di bawah <b>15 tahun</b>. Jika Anda mengetahui adanya data anak yang terkumpul, segera hubungi kami untuk tindakan lebih lanjut.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Kami dapat memperbarui kebijakan ini kapan saja. Setiap perubahan besar akan diumumkan melalui situs atau email resmi. 
        ...
        <section>
          ...
          <ul class="space-y-2">
            <li><strong>Email:</strong> <a href="" class="text-blue-600 hover:underline">support@makandulu.id</a></li>
            <li><strong>Telepon:</strong> <a href="" class="text-blue-600 hover:underline">+62 812-3456-7890   </a></li>
        ...
        <p class="text-sm text-gray-600 text-center">
          Dengan menggunakan layanan <span class="text-blue-600 font-semibold">Makan</span><span class="text-yellow-500 font-semibold">Dulu</span>, Anda menyetujui pengumpulan dan penggunaan informasi sesuai kebijakan ini.
        </p>
      </div>

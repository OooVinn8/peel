...
@section('content')
    <div class="min-h-screen flex items-center justify-center bg-gray-100">
        ...
        <div
            class="w-full md:w-[1200px] md:h-[650px] bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
            ...
            <div class="w-full md:w-[35%] flex flex-col justify-center px-6 md:px-10 py-8 md:py-12">
                <div class="w-full max-w-sm mx-auto">
                    ...
                    <p class="mt-6 text-sm text-gray-600 text-center">
                        Sudah punya akun?
                        <a href="{{ url('/login') }}" class="text-yellow-500 font-semibold hover:underline">Masuk di
                            sini</a>
                    </p>
                </div>
            </div>
            ...
            <div
                class="w-full md:w-[65%] hidden md:flex flex-col items-center justify-center bg-gradient-to-br from-red-50 to-yellow-50 px-6">
                ...
                <lottie-player src="{{ asset('images/LhuvVioiPQ.json') }}" background="transparent" speed="1"

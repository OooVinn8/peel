    ...
    <div class="w-full bg-white py-24 grid md:grid-cols-2 gap-16 items-center">
        <div class="order-2 md:order-1 px-10 md:px-20" data-aos="fade-right">
            ...
            <p class="text-gray-700 leading-relaxed mb-4">
                Semua bermula dari sebuah ide sederhana — bagaimana jika makan tidak sekadar soal kenyang, tapi juga tentang
                kenyamanan, kehangatan, dan kebersamaan. Dari situ lahirlah <span
                    class="text-blue-600 font-semibold">Makan</span><span class="text-yellow-500 font-semibold">Dulu</span>,
                sebuah tempat di mana setiap orang bisa berhenti sejenak dari rutinitas dan menikmati waktu dengan tenang.
            </p>
            <p class="text-gray-700 leading-relaxed">
                Kami percaya bahwa setiap hidangan punya cerita, dan setiap pelanggan membawa kisahnya sendiri. Dengan
                suasana yang hangat dan pelayanan yang tulus, kami ingin setiap kunjungan menjadi momen yang berarti — entah
                untuk bekerja, berbagi tawa, atau sekadar menikmati kopi di sore hari.
            </p>
        </div>
        ...
        <div class="order-1 md:order-2 flex justify-center" data-aos="fade-left">
            <div class="relative">
                ...
                <img src="{{ asset('images/suasana.jpg') }}" alt="Suasana Cafe"
    ...
    <div class="bg-gray-100 py-20 w-full">
        <div class="text-center mb-14">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto text-base md:text-lg">
                Di balik setiap cita rasa dan suasana hangat <span class="text-blue-600 font-semibold">Makan</span><span
                    class="text-yellow-500 font-semibold">Dulu</span>,
        ...
        <div class="grid md:grid-cols-3 gap-8 px-6 md:px-20 text-center">
            ...
            <div class="bg-white rounded-3xl p-6 shadow-md hover:shadow-xl transition duration-500 hover:-translate-y-2">
                <img src="{{ asset('image_founder/davin.png') }}" alt="Davin Octaryan"
                ...
                <p class="text-gray-700 text-sm leading-relaxed">
                    "Di <span class="text-blue-600 font-semibold">Makan</span><span
                        class="text-yellow-500 font-semibold">Dulu</span>. setiap rasa punya makna — kami masak bukan cuma
                    buat kenyang, tapi buat dikenang.”
                </p>
            </div>

            {{-- Founder 2 --}}
            <div class="bg-white rounded-3xl p-6 shadow-md hover:shadow-xl transition duration-500 hover:-translate-y-2">
                <img src="{{ asset('image_founder/hanssen.png') }}" alt="Hanssen"
                    class="w-32 h-32 object-cover rounded-full mx-auto mb-5 border-4 border-yellow-400 shadow-md">
                ...
                <p class="text-gray-700 text-sm leading-relaxed">
                    "Buat kami, <span class="text-blue-600 font-semibold">Makan</span><span
                        class="text-yellow-500 font-semibold">Dulu</span>, bukan sekadar tempat makan, tapi ruang hangat
                    buat berbagi cerita.”
                </p>
            </div>
            ...
            {{-- Founder 3 --}}
            <div class="bg-white rounded-3xl p-6 shadow-md hover:shadow-xl transition duration-500 hover:-translate-y-2">
                <img src="{{ asset('image_founder/kevin.png') }}" alt="Kevin Alera"
                    class="w-32 h-32 object-cover rounded-full mx-auto mb-5 border-4 border-yellow-400 shadow-md">
                <h3 class="text-xl font-bold text-blue-700 mb-1">Kevin Alera</h3>
                <p class="text-gray-600 text-sm mb-3">Co-Founder & Operations Lead
                <p class="text-gray-700 text-sm leading-relaxed">
                    “Semua hal kecil di <span class="text-blue-600 font-semibold">Makan</span><span
                        class="text-yellow-500 font-semibold">Dulu</span> kami jaga dengan sepenuh hati — karena kebahagiaan
                    pelanggan selalu jadi resep utama.”
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white py-24 w-full">
        <div class="w-full text-center">
            ...
            <p class="max-w-3xl mx-auto text-gray-700 text-lg leading-relaxed mb-16">
                Di <span class="text-blue-600 font-semibold">Makan</span><span
                    class="text-yellow-500 font-semibold">Dulu</span>, setiap detail kami pikirkan dengan cinta — mulai dari
                bahan pilihan, cara penyajian, hingga pelayanan yang hangat.
                Kami ingin setiap tamu merasakan bahwa di sini, makan bukan hanya kebutuhan, tapi juga kebahagiaan kecil
                yang berharga.
            </p>

            <div class="grid md:grid-cols-3 gap-10 px-10 md:px-20">
                <div
                    class="bg-white rounded-3xl p-10 shadow-md hover:shadow-xl hover:-translate-y-2 transition duration-500">
                ...
                <div
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        Biru untuk ketenangan, kuning untuk kehangatan — dua warna yang berpadu menciptakan ruang
                        menenangkan hati dan menumbuhkan semangat positif.
                    </p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        ...
                        <span class="text-blue-600 font-semibold">Makan</span><span
                            class="text-yellow-500 font-semibold">Dulu</span>.
                    </p>
                </div>
            </div>

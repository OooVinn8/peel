...
<div class="max-w-7xl mx-auto px-6 py-10">
  ...
  <div class="flex justify-center mb-6">
    <form method="GET" action="{{ route('menu.main') }}" class="relative w-full md:w-1/2">
      <input
        type="text" name="search" value="{{ request('search') }}" placeholder="Cari menu disini..." class="w-full rounded-full border border-gray-300 px-4 py-2 focus:ring-2 focus:ring-yellow-400 focus:outline-none">
      <button
        type="submit"

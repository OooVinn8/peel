<nav class="relative z-50 flex items-center justify-between px-6 py-4 bg-white border-b shadow-md">
    ...
    <div class="flex items-center space-x-4">
        @if (Auth::check())
            <a href="{{ url('/cart') }}" class="flex items-center space-x-2 hover:opacity-80 transition">
